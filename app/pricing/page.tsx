...
const tiers = [
  ...
  },
  {
    ...
    price: "$19",
    cadence: "/month",
    tagline: "For growing SaaS teams and consultants",
  ...
  },
  {
    name: "Team",
    price: "Custom",
    tagline: "For enterprise compliance and security",
    ...
    features: [
      ...
      "SAML SSO + SCIM",
      "Access reviews + SLA incidents",
      "Key rotation + retention controls",
      "Email alerts",
    ],
  },
];
