      ...
      <div className="bg-slate-50 border-t border-slate-200 p-8 flex items-end justify-between mt-auto">
         <div className="max-w-md">
            ...
            <p className="text-[10px] text-slate-500 leading-relaxed mb-4">
                This document is designed to serve as a record of a webhook delivery. 
                {signatureStatus === 'verified' && " It includes verification data indicating the payload matched the provider's signature."}
                The content above represents the data received/provided at the timestamp shown.
                Generated by LanceIQ, the webhook verification toolkit.
            </p>
