  ...
  return (
    ...
    >
      ...
      <div className="bg-slate-900 text-white px-12 py-10 flex justify-between items-start relative z-10">
        <div>
          <h1 className="text-3xl font-bold tracking-tight mb-2">Webhook Delivery Record</h1>
          <div className="flex items-center gap-2 opacity-80 text-sm">
             <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
             <span>Official Proof of Delivery</span>
          </div>
        </div>
      ...
      <div className="bg-slate-50 border-t border-slate-200 p-8 flex items-end justify-between mt-auto">
         <div className="max-w-md">
            <p className="font-bold text-slate-900 text-sm mb-2">Certification Notice</p>
            <p className="text-[10px] text-slate-500 leading-relaxed mb-4">
                This document acts as a permanent record of a webhook delivery. 
                {signatureStatus === 'verified' && " It includes cryptographic proof that the payload originated from the stated provider."}
                The content above represents the exact data received/provided at the timestamp shown.
                Generated by LanceIQ, the professional webhook verification toolkit.
            </p>
